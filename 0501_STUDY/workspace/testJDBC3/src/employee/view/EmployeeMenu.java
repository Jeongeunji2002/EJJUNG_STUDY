		...
		do {
			...
			try {
				...
				case 1:
					...
					break;
				case 2:
					Employee emp = econtroller.selectEmp(inputEmpId());
					if (emp != null) {
					...
					break;
				case 3:
					econtroller.insertEmp(inputEmp());
					break;
				case 4:
					econtroller.updateEmp(modifyEmp());
					break;
				case 5:
					...
					break;
				case 6:
					printList(econtroller.selelctDept(inputDeptId()));
					break;
				case 7:
				...
				printError("오류 발생 : " + e.getLocalizedMessage());
			}
