...
// 작성규칙 : 
// 1. 반드시 캡슐화할 것 : 모든 필드를 private 할 것
// 2. 기본생성자와 매개변수 있는 생성자를 가지고 있어야 함
// 3. 모든 필드에 대한 getter and setter 를 가지고 있어야 함
// 4. toString(), equals() 등에 대한 오버라이딩(선택사항)
...
public class Person implements java.io.Serializable {
	...
	public boolean equals(Object obj) {
		...
		// 후손이 가진 필드를 다루려면, 부모타입에서 후손타입으로 형변환을 해야한다 : DownCasting
		// (후손클래스명)부모타입레퍼런스
	...
	// 부모의 접근제한자보다 더 넓은 범위의 것으로 변경 가능
	// public > protected > default(package private) > private
	// 부모가 가진 예외를 갯수를 줄일 수 있음 : 0개까지 가능
	@Override
	public Object clone(){
