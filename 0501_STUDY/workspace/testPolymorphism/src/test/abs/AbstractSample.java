...
//상속을 통해서 후손이 부모의 미완성 부분을 강제로 완성시키도록 하기 위한 목적으로 만들어지는 클래스
...
public abstract class AbstractSample {
	...
	//Method
	//추상(abstract) 메소드 : 미완성 메소드를 멤버로 가진 클래스는 반드시 class 앞에 abstract 를 붙여야 한다
	//메소드 헤드 (메소드 선언부 : 시그니쳐)만 있고, 메소드 바디(구현부)가 없는 메소드
	//접근제한자 [예약어] 반환자료형 메소드명(자료형 매개변수 , ...);
	...
	public final void printlnformation() {
